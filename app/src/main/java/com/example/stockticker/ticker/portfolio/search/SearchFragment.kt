...
import com.example.stockticker.ticker.network.data.Suggestion
...
class SearchFragment : BaseFragment(), ChildFragment, SuggestionsAdapter.SuggestionClickListener, TextWatcher {
    ...
    @Inject
    internal lateinit var stocksApi: StocksApi
